<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aboutDefault.aspx.cs" Inherits="RentACar.aboutDefault" %>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <br>
                        <br>
                        <h2>Hakkımızda Daha Fazla <em>Bilgi Öğren!</em></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" id="tabs">
              ...
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    <img src="template165/car-rental-website-template-165/assets/images/about-image-1-940x460.jpg" alt="">
                    <h4>Hedeflerimiz</h4>
                     <p>
                         Araç kiralama dünyasının global çaplı, en başarılı isimlerden biri olarak size ayrıcalıklı ve konforlu bir hizmet vermek için buradayız. En iyi fiyat garantisi, senede iki kez yenilenen araç filosu, mil kazanma fırsatı gibi avantajlarla sunduğumuz araç filomuzu inceleyerek yolculuğunuzun tadını çıkarabilirsiniz.
                     </p>
                </section>
              </div>
            </div>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        ...
                        <div class="main-button">
                            <a href="contactDefault.aspx">İletişime Geç</a>
                        </div>
                    </div>
                </div>
            </div>
